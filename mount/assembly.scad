...
module telescope_proxy() {
    ...
    color("silver", 0.5) {
        ...
        // The brackets are PIERCED -- that is the whole point of them.
        // Modelling them solid made the axle passing through read as
        // 224 mm3 of interference: a proxy defect, not a design one.
        for (s = [-1, 1])
            difference() {
